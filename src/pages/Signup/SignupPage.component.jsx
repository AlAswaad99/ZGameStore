      ...
      >
        ...
        /> */}
            ...
            <div className="flex justify-center">
              <p className="mt-2 inline-block">Already have an account? </p>{" "}
              <p className="underline font-semibold cursor-pointer ml-2 mt-2 inline-block" onClick={e=>history.replace("login")}>
                Sign in
              </p>
            </div>
          </form>
